...
export default function About() {
  return (
    <section
      id="about"
      className="px-3 md:px-12 lg:px-24 py-20 h-auto"
    >
      {/* Section Header */}
      <div>
      ...
      {/* Main Heading */}
      <h3 className="text-2xl md:text-3xl lg:text-5xl mb-3 font-bold tracking-tighter leading-[1.2] text-foreground">
